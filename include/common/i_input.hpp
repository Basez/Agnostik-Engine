...
namespace AGN
{
	...
	public:
		...
		virtual void registerMouseClick(AGN::EMOUSECODE a_mouseButton) = 0;
		virtual void registerMouseHold(AGN::EMOUSECODE a_mouseButton, bool a_held) = 0;
		virtual void registerHold(AGN::ESCANCODE a_key, bool a_held) = 0;
		...
		virtual bool getKeyDown(AGN::ESCANCODE a_key) = 0;
		virtual bool getKeyUp(AGN::ESCANCODE a_key) = 0;
		virtual bool getKey(AGN::ESCANCODE a_key) = 0;
		virtual bool getMouseDown(AGN::EMOUSECODE a_mouseButton) = 0;
		virtual bool getMouseUp(AGN::EMOUSECODE a_mouseButton) = 0;
		virtual bool getMouse(AGN::EMOUSECODE a_mouseButton) = 0;
		...
		// callback systems
		virtual void addMouseMotionHandler(class IInputMouseMotionHandler* a_motionHandler) = 0;
		virtual void removeMouseMotionHandler(class IInputMouseMotionHandler* a_motionHandler) = 0;
		virtual void addMouseClickHandler(class IInputMouseClickHandler* a_clickHandler) = 0;
		virtual void removeMouseClickHandler(class IInputMouseClickHandler* a_clickHandler) = 0;
	...
	class IInputMouseMotionHandler
	{
	public:
		virtual ~IInputMouseMotionHandler() {};
		virtual void onMouseMotion(int a_mouseX, int a_mouseY) = 0;
	};

	// interface for handling mouse click events
	class IInputMouseClickHandler
	{
	public:
		virtual ~IInputMouseClickHandler() {};
